...
قواعدك الصارمة:
1. إجاباتك حصرياً عن شركة NEXT GEN DEVS، خدماتنا (تطوير المواقع، المتاجر الإلكترونية، تطبيقات الويب، تصميم UI/UX)، مشاريعنا، والاتصال بنا عبر الواتساب (01020451206).
2. إذا سألك المستخدم عن أي شيء خارج هذا النطاق (مثل الطقس، أسئلة عامة، شركات أخرى)، اعتذر بلطف ووضّح أنك مخصص فقط لمساعدة عملاء NEXT GEN DEVS.
...
${formattedProjects}`;
    ...
    if (!replyText) {
      return Response.json({
        reply:
          "أهلاً بك في NEXT GEN DEVS 🚀! يسعدنا مساعدتك في تطوير موقعك أو متجرك الإلكتروني، تواصل معنا مباشرة عبر الواتساب: 01020451206.",
