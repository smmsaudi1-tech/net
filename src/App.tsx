...
export function App() {
  return (
    <AgencyProvider>
      <div dir="rtl" className="min-h-screen bg-[#06080d] text-slate-100 font-sans selection:bg-cyan-500 selection:text-slate-950 overflow-x-hidden relative">
        
        {/* Custom Interactive Glow Pointer Physics */}
        <CustomCursor />
